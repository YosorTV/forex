      ...
      <div className="space-y-4 sm:space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 text-base">
          <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-4 sm:p-5 hover:border-gray-300 transition-colors">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-navy mb-2">Серверная часть</h3>
          ...
          <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-4 sm:p-5 hover:border-gray-300 transition-colors">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-navy mb-2">Пользовательский интерфейс</h3>
            <p className="text-textPrimary">
          ...
          <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-4 sm:p-5 hover:border-gray-300 transition-colors">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-navy mb-2">Универсальные таблицы</h3>
            <p className="text-textPrimary">
          ...
          <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-4 sm:p-5 hover:border-gray-300 transition-colors">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-navy mb-2">Система компонентов</h3>
            <p className="text-textPrimary">
        ...
        <div className="bg-blue-50/50 border border-blue-200 rounded-xl p-4 sm:p-5">
