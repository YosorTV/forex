      ...
      <div className="space-y-4 sm:space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 text-base">
          <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-4 sm:p-5 hover:border-gray-300 transition-colors">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-navy mb-2">Вход и защита</h3>
          ...
          <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-4 sm:p-5 hover:border-gray-300 transition-colors">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-navy mb-2">6-уровневая иерархия ролей</h3>
          ...
          <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-4 sm:p-5 hover:border-gray-300 transition-colors">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-navy mb-2">Ограничение видимости</h3>
            <p className="text-textPrimary">
          ...
          <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-4 sm:p-5 hover:border-gray-300 transition-colors">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-navy mb-2">Полный журнал действий</h3>
            <p className="text-textPrimary">
