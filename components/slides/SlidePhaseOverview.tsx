    ...
    >
      <div className="space-y-4 sm:space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 text-base">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 border border-blue-200/60 rounded-xl p-4 sm:p-5 hover:border-blue-300 transition-colors">
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-indigo-100/50 border border-indigo-200/60 rounded-xl p-4 sm:p-5 hover:border-indigo-300 transition-colors">
            <div className="flex items-center gap-3 mb-2">
          ...
          <div className="bg-gradient-to-br from-cyan-50 to-cyan-100/50 border border-cyan-200/60 rounded-xl p-4 sm:p-5 hover:border-cyan-300 transition-colors">
            <div className="flex items-center gap-3 mb-2">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-teal-100/50 border border-teal-200/60 rounded-xl p-4 sm:p-5 hover:border-teal-300 transition-colors">
            <div className="flex items-center gap-3 mb-2">
          ...
          <div className="bg-gradient-to-br from-emerald-50 to-emerald-100/50 border border-emerald-200/60 rounded-xl p-4 sm:p-5 hover:border-emerald-300 transition-colors">
            <div className="flex items-center gap-3 mb-2">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100/50 border border-green-200/60 rounded-xl p-4 sm:p-5 hover:border-green-300 transition-colors">
            <div className="flex items-center gap-3 mb-2">
          ...
          <div className="md:col-span-2 bg-gradient-to-br from-lime-50 to-lime-100/50 border border-lime-200/60 rounded-xl p-4 sm:p-5 hover:border-lime-300 transition-colors">
            <div className="flex items-center gap-3 mb-2">
        ...
        <div className="bg-gradient-to-r from-navy/5 to-darkGreen/5 border-2 border-navy/20 rounded-xl p-4 sm:p-5 text-center">
          <p className="text-base sm:text-lg font-semibold text-navy mb-2">
