    ...
    >
      <div className="space-y-4 stagger-children">
        <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-5 hover:border-gray-300 transition-colors">
          ...
          <h3 className="text-xl font-bold text-navy mb-2">Всё в одном месте</h3>
        ...
        <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-5 hover:border-gray-300 transition-colors">
          ...
          <h3 className="text-xl font-bold text-navy mb-2">Автоматический контроль</h3>
          <p className="text-textPrimary">
        ...
        <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-5 hover:border-gray-300 transition-colors">
          ...
          <h3 className="text-xl font-bold text-navy mb-2">Готово для проверок</h3>
          <p className="text-textPrimary">
        ...
        <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-5 hover:border-gray-300 transition-colors">
          ...
          <h3 className="text-xl font-bold text-navy mb-2">Надежная инфраструктура</h3>
          <p className="text-textPrimary">
        ...
        <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-5 hover:border-gray-300 transition-colors">
          ...
          <h3 className="text-xl font-bold text-navy mb-2">Гибкий рост</h3>
          <p className="text-textPrimary">
      ...
      <div className="mt-6 bg-gradient-to-r from-navy to-accentBlue text-white px-8 py-4 rounded-2xl text-center">
        <p className="text-lg font-semibold">Microsoft Azure — проверенное решение для финансовых систем</p>
      </div>
    </SlideLayout>
  );
}
