      ...
      <div className="space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-base">
          <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-5 hover:border-gray-300 transition-colors">
            ...
            <h3 className="text-xl font-bold text-navy mb-2">База лидов</h3>
          ...
          <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-5 hover:border-gray-300 transition-colors">
            ...
            <h3 className="text-xl font-bold text-navy mb-2">Карточка лида</h3>
            <p className="text-textPrimary">
          ...
          <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-5 hover:border-gray-300 transition-colors">
            ...
            <h3 className="text-xl font-bold text-navy mb-2">Миграция между офисами</h3>
            <p className="text-textPrimary">
          ...
          <div className="bg-gray-50/80 border border-gray-200/60 rounded-xl p-5 hover:border-gray-300 transition-colors">
            ...
            <h3 className="text-xl font-bold text-navy mb-2">Импорт данных</h3>
            <p className="text-textPrimary">
          ...
          <div className="md:col-span-2 bg-gray-50/80 border border-gray-200/60 rounded-xl p-5 hover:border-gray-300 transition-colors">
            ...
            <h3 className="text-xl font-bold text-navy mb-2">Полная история</h3>
            <p className="text-textPrimary">
